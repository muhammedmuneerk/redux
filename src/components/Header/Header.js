...
const Header = () => {
   ...
   // cartList= [ {count} {count} {count} , total ] ---> this is why here .reduce used / or thats how .reduce works
   ...
   return (
      ...
      </header> //{cartList?.length} total of carts <-> {totalCartCount} total of each carts count
   )
}
